...
int main() {
    ...
    scanf("%d",&num1);
    printf("Type another number_2: ");
    scanf("%d",&num2);
    swap(&num1, &num2);
    printf("\nThe numbers are swappe
    printf("Now, number_1:%d",num1)
    printf("Now, number_2:%d",num2);
return 0;
}
void swap(int*ptr_1, int*ptr_2){
...
// int *ptr=&array[0];
//     for(i = 0; i<num; i++) {
//        printf("Enter the elements of your array at index %d,i+1");
//scanf("%d",(ptr+i));
//     for(i = 0; i<num; i++) {
